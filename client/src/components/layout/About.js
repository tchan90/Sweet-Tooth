...
class About extends Component {
    render() {
        return (
            <div>
                <Container fluid={true} className = "card-banner-start  about-card-bg">
        <Row className = "text-center">
          <Col lg={8} className = "m-auto pb-3">
              <h1 className="card-banner-title" id="about">About Us</h1>
              <FontAwesomeIcon icon="cookie-bite" color="#E6D896" size="3x" className = "mb-2"/>
              ...
              <p>Donec in ullamcorper quam. Integer euismod blandit metus, ut mollis massa tempor sed. Vestibulum accumsan massa non gravida sollicitudin. Praesent faucibus nibh ante, vitae fermentum elit pulvinar et. Curabitur faucibus velit sit amet arcu dapibus auctor. In nisi nunc, semper sit amet nulla nec, rhoncus scelerisque tortor. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Vestibulum porta sodales maximus. Proin sollicitudin at eros in tincidunt. Morbi lacus erat, lobortis nec diam ut, aliquet viverra justo.</p></div>
          </Col>
        </Row>
      </Container>
            </div>
